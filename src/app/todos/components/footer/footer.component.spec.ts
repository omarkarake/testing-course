...
describe('FooterComponent', () => {
  ...
  describe('filters', () => {
    it('highlight default filter', () => {
      const filterLink = fixture.debugElement.queryAll(
        By.css('[data-testid="filterLink"]')
      );
      expect(filterLink[0].classes['selected']).toBe(true);
    });
    it('changes a filter', () => {
      const filterLink = fixture.debugElement.queryAll(
        By.css('[data-testid="filterLink"]')
      );
      filterLink[1].triggerEventHandler('click');
